...
<<<<<<< HEAD
    ...
    },
    {
      ...
      answer:
        "Commission rates vary by program and categories, typically ranging from 1% to 50%. Our platform shows you the exact rates for each program before you apply, so you can make informed decisions.",
    },
    {
      question: "How quickly do I get paid?",
      answer:
        "Payment schedules depend on individual affiliate programs. Most programs pay monthly, with some offering weekly or bi-weekly payments. We display payment terms clearly for each program.",
    },
    {
      question: "Is there a minimum payout threshold?",
      answer:
        "Minimum payout thresholds vary by program. We aggregate your earnings across programs where possible to help you reach payout thresholds faster.",
    },
    {
      question: "Can I track performance across all my programs?",
      answer:
        "Yes! Our unified dashboard shows performance metrics across all your affiliate programs in one place, including clicks, conversions, and earnings.",
    },
    {
      question: "Do you provide marketing materials?",
      answer:
        "Many of our partner programs provide banners, product images, and promotional content. We organize these materials in your dashboard for easy access.",
    },
    {
      question: "Is Affitor suitable for beginners?",
      answer:
        "Absolutely! We provide educational resources, best practices guides, and step-by-step tutorials to help beginners get started with affiliate marketing.",
    },
    {
