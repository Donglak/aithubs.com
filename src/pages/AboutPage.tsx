...
<<<<<<< HEAD
    ...
    },
    {
      ...
      description:
        "Our users' success is our priority. We build tools and content that truly help people achieve their goals.",
    },
    {
      icon: Award,
      title: "Quality Standards",
      description:
        "We rigorously test and evaluate every tool before recommending it to our community.",
    },
    {
      icon: TrendingUp,
...
<<<<<<< HEAD
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-gray-900 dark:text-gray-300 leading-relaxed mb-6">
              DigitalToolsHub was born from a simple frustration: the
              overwhelming number of digital tools available today makes it
              nearly impossible to know which ones actually work and which ones
              are worth your investment.
            </p>

            <p className="text-gray-900 dark:text-gray-300 leading-relaxed mb-6">
              As entrepreneurs and digital marketers ourselves, we spent
              countless hours and thousands of dollars testing tools that
              promised the world but delivered little. We realized there had to
              be a better way to help people navigate the digital tools
              landscape.
            </p>

            <p className="text-gray-900 dark:text-gray-300 leading-relaxed mb-6">
              That's when we decided to create DigitalToolsHub - a platform
              where real experts test, review, and recommend only the tools that
              truly make a difference. Every tool in our directory has been
              personally tested by our team, and every review is based on
              real-world usage and results.
            </p>

            <p className="text-gray-900 dark:text-gray-300 leading-relaxed">
              Today, we're proud to have helped over 50,000 users discover tools
              that have collectively saved them millions of dollars and
