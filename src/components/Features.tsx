...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Track clicks, conversions, and earnings with detailed real-time analytics.",
    },
    {
      icon: Link,
      title: "Link Management",
      description:
        "Create, organize, and optimize your affiliate links in one central dashboard.",
    },
    {
      icon: Shield,
      title: "Fraud Protection",
      description:
        "Advanced security measures to protect your commissions and reputation.",
    },
    {
      icon: Zap,
      title: "Auto Optimization",
      description:
        "AI-powered recommendations to maximize your affiliate marketing performance.",
    },
    {
      icon: Globe,
