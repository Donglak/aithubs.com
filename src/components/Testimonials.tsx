  ...
  const testimonials = [
    {
      ...
      quote:
        "Affitor transformed my affiliate marketing game. I increased my revenue by 300% in just 3 months!",
      rating: 5,
    },
    {
      name: "Mike Chen",
      ...
      quote:
        "The analytics dashboard is incredible. I can finally see which programs are actually profitable.",
      rating: 5,
    },
    {
