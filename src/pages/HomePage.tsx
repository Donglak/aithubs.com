...
const getCategoryDescription = (label: string) => {
  ...
  const keyMap: Record<string, string> = {
    "Marketing & Advertising":
      "sections.discovery.categoryDescriptions.marketingAdvertising",
    "Finance & Fintech / Accounting":
      "sections.discovery.categoryDescriptions.financeFintechAccounting",
    "Productivity & Workflow":
      "sections.discovery.categoryDescriptions.productivityWorkflow",
    "Creative & Design":
      "sections.discovery.categoryDescriptions.creativeDesign",
    "Software / DevTools":
      "sections.discovery.categoryDescriptions.softwareDevtools",
    "HR / Recruiting": "sections.discovery.categoryDescriptions.hrRecruiting",
    "Education / EdTech":
      "sections.discovery.categoryDescriptions.educationEdtech",
    "E-commerce": "sections.discovery.categoryDescriptions.ecommerce",
    Travel: "sections.discovery.categoryDescriptions.travel",
  };
...
const getFunctionDescription = (label: string) => {
  ...
  const keyMap: Record<string, string> = {
    "Automation / Workflow":
      "sections.functions.functionDescriptions.automationWorkflow",
    "Analytics & Reporting":
      "sections.functions.functionDescriptions.analyticsReporting",
    "Content Management":
      "sections.functions.functionDescriptions.contentManagement",
    "Lead Gen / CRM / Sales Funnel":
      "sections.functions.functionDescriptions.leadGenCrmSalesFunnel",
    "Design / Creative Tools":
      "sections.functions.functionDescriptions.designCreativeTools",
    "SEO & Ads Optimization":
      "sections.functions.functionDescriptions.seoAdsOptimization",
    "Chatbot / Agent": "sections.functions.functionDescriptions.chatbotAgent",
    "AI Text Generation":
      "sections.functions.functionDescriptions.aiTextGeneration",
    "AI Image / Voice / Video Generation":
      "sections.functions.functionDescriptions.aiImageVoiceVideoGeneration",
  };

  return t(keyMap[label] || "sections.functions.functionDescriptions.default");
};
...
<<<<<<< HEAD
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebSite",
            name: "AIThub",
            url: "https://aithubs.com",
            description:
              "Discover the best digital tools for AI, marketing automation, and making money online. Expert reviews, comparisons, and exclusive deals.",
            potentialAction: {
              "@type": "SearchAction",
              target: {
                "@type": "EntryPoint",
                urlTemplate:
                  "https://aithubs.com/tools?search={search_term_string}",
              },
